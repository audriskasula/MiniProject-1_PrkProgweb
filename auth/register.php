...
<body>
    ...
    <div class="container center-card-layout">
        <div class="glass-card form-container" style="max-width: 500px;">
            ...
            <p style="color: var(--text-muted); margin-bottom: 2rem; text-align: center;">Bergabunglah bersama kami
                untuk mulai berdonasi.</p>
            ...
            <?php else: ?>
                ...
                <form action="register.php" method="POST" id="registerForm">
                    ...
                    <p id="passwordError"
                        style="color: #dc2626; font-size: 0.85rem; margin-top: -10px; margin-bottom: 10px; display: none;">
            ...
            <p style="margin-top: 1.5rem; color: var(--text-muted); font-size: 0.9rem; text-align: center;">
                Sudah punya akun? <a href="login.php"
                    style="color: var(--primary); text-decoration: none; font-weight: bold;">Login di sini</a>
            </p>
        </div>
    </div>
