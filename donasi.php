    ...
    <div class="container center-card-layout">
        <div class="glass-card form-container">
            ...
            <div style="background: rgba(255,255,255,0.05); padding: 1.5rem; border-radius: 12px; margin-bottom: 2rem;">
                <h3 style="margin-bottom: 0.5rem; font-size: 1.1rem;"><?php echo htmlspecialchars($k['judul_kampanye']); ?></h3>
                <p style="color: var(--text-muted); font-size: 0.9rem;">
                    Terkumpul: Rp <?php echo number_format($k['dana_terkumpul'], 0, ',', '.'); ?> dari Target: Rp <?php echo number_format($k['target_dana'], 0, ',', '.'); ?>
                </p>
            ...
            <form action="donasi.php?id=<?php echo $kampanye_id; ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="pesan_dukungan" class="form-control" rows="3" placeholder="Tuliskan doa atau dukungan anda..."></textarea>
                </div>
