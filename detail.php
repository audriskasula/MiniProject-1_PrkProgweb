        ...
        <div class="detail-layout">
            <div class="detail-content">
                ...
                <p class="detail-organizer-box">
                    <span class="text-lg">👤</span> Diselenggarakan oleh: <?php echo htmlspecialchars($k['nama_penyelenggara']); ?> 
                    (<a href="mailto:<?php echo htmlspecialchars($k['email_penyelenggara']); ?>"><?php echo htmlspecialchars($k['email_penyelenggara']); ?></a>)
                </p>
                ...
                <div class="glass-card sticky-sidebar">
                    ...
                    <div class="donation-stats">
                        <div class="stat-item">
                            ...
                            <span class="stat-value">Rp <?php echo number_format($k['dana_terkumpul'], 0, ',', '.'); ?></span>
                        </div>
                    ...
                    <div class="stat-item" style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid var(--border);">
                        <span class="stat-label">Target Dana</span>
                        <span class="stat-value" style="color: var(--text);">Rp <?php echo number_format($k['target_dana'], 0, ',', '.'); ?></span>
                    </div>
                    
                    <div class="stat-item" style="margin-top: 1rem;">
                        <span class="stat-label">Transfer Ke</span>
                        <span class="stat-value" style="color: var(--primary); font-size: 1rem;"><?php echo htmlspecialchars($k['rekening_donasi']); ?></span>
                    </div>

                    <a href="donasi.php?id=<?php echo $k['id']; ?>" class="btn-primary" style="display: block; text-align: center; margin-top: 2rem;">Donasi Sekarang</a>
                </div>
            </div>
        </div>
    </div>
